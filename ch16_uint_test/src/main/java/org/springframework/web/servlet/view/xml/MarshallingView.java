...
/**
 * Spring-MVC {@link org.springframework.web.servlet.View} that allows for response context to be rendered as the result of marshalling by a {@link
 * Marshaller}.
 *
 * <p>The Object to be marshalled is supplied as a parameter in the model and then {@linkplain
 * #locateToBeMarshalled(java.util.Map) detected} during response rendering. Users can either specify a specific entry in the
...
public class MarshallingView extends AbstractView {
	 ...
	 * @throws javax.servlet.ServletException if the model object specified by the {@linkplain #setModelKey(String) model key} is not
