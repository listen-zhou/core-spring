...
public class GetRefinedTopicCountResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.baobaotao.ws.server.springws.schema.messages.v2.GetRefinedTopicCountResponseDocument
{
     ...
     */
    public GetRefinedTopicCountResponse getGetRefinedTopicCountResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
            GetRefinedTopicCountResponse target = null;
            target = (GetRefinedTopicCountResponse)get_store().find_element_user(GETREFINEDTOPICCOUNTRESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setGetRefinedTopicCountResponse(GetRefinedTopicCountResponse getRefinedTopicCountResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (GetRefinedTopicCountResponse)get_store().add_element_user(GETREFINEDTOPICCOUNTRESPONSE$0);
            }
     ...
     */
    public GetRefinedTopicCountResponse addNewGetRefinedTopicCountResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class GetRefinedTopicCountResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements GetRefinedTopicCountResponse
    {
        private static final long serialVersionUID = 1L;
