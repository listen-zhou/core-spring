...
public class GetRefinedTopicCountRequestDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.baobaotao.ws.server.springws.schema.messages.v1.GetRefinedTopicCountRequestDocument
{
     ...
     */
    public GetRefinedTopicCountRequest getGetRefinedTopicCountRequest()
    {
        synchronized (monitor())
        {
            check_orphaned();
            GetRefinedTopicCountRequest target = null;
            target = (GetRefinedTopicCountRequest)get_store().find_element_user(GETREFINEDTOPICCOUNTREQUEST$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setGetRefinedTopicCountRequest(GetRefinedTopicCountRequest getRefinedTopicCountRequest)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (GetRefinedTopicCountRequest)get_store().add_element_user(GETREFINEDTOPICCOUNTREQUEST$0);
            }
     ...
     */
    public GetRefinedTopicCountRequest addNewGetRefinedTopicCountRequest()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class GetRefinedTopicCountRequestImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements GetRefinedTopicCountRequest
    {
        private static final long serialVersionUID = 1L;
