...
import com.baobaotao.oxm.xstream.objectstreams.ObjectStreamSample;
...
public class XStreamJSONSample {
	...
	public static void toJsonByJettisonMappedXmlDriver()throws Exception {
		User user = getUser();
		FileOutputStream outputSteam = new FileOutputStream("D:\\masterSpring\\chapter14\\out\\JettisonMappedSample.json");
	...
	public static void toJsonByJsonHierarchicalStreamDriver()throws Exception {
		User user = getUser();
		FileOutputStream outputSteam = new FileOutputStream("D:\\masterSpring\\chapter14\\out\\JsonByJsonHierarchicalSample.json");
        OutputStreamWriter writer = new OutputStreamWriter(outputSteam, Charset.forName("UTF-8"));    
	...
	public static User jsonToObject()throws Exception{
		String json = "{\"user\":{\"userId\":1,\"userName\":\"xstream\",\"credits\":0,\"logs\":[{\"com.baobaotao.domain.LoginLog\":[{\"loginLogId\":0,\"userId\":0,\"ip\":\"192.168.1.91\",\"loginDate\":\"2011-08-08 00:16:41.196 CST\"},{\"loginLogId\":0,\"userId\":0,\"ip\":\"192.168.1.92\",\"loginDate\":\"2011-08-08 00:16:41.196 CST\"}]}]}}";
		xstream = new XStream(new JettisonMappedXmlDriver());
	    xstream.alias("user", User.class);
